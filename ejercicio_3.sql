...
SELECT 
    ...
    ivr_modules.module_name AS calls_steps_module,
    ivr_modules.module_name AS calls_module_aggregation,
...
LEFT JOIN 
    `keepcoding.ivr_modules` AS ivr_modules
ON 
    ivr_calls.ivr_id = ivr_modules.ivr_id
LEFT JOIN 
    `keepcoding.ivr_steps` AS ivr_steps
ON 
